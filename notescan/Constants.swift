...
class Constants {
    ...
    /// API Keys
    static let revenueCat = "appl_XpJhzYJhKkLkJltzxQHHdRtWNuk" /// IMPORTANT: This API key is set to notescan RevenueCat project. Change it to yours...
    static let mixpanel = "c05ffe94852ccb674634dbde5ba28118" /// IMPORTANT: Change this API key to your MixPanel key...
    
    static let openAIKey = "sk-proj-..." /// IMPORTANT: Change this API key to your OpenAI key...
    
    static let proxyLambdaURL = "https://icguuadpqf.execute-api.us-east-1.amazonaws.com/default/openai_function"
}
