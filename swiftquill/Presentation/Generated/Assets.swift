...
public enum Asset {
  ...
  public enum Images {
    ...
    public static let author = ImageAsset(name: "author")
    ...
    public static let twitch = ImageAsset(name: "twitch")
    public static let twitterColor = ImageAsset(name: "twitter_color")
  }
}
