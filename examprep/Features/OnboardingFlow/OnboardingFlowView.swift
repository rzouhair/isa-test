...
enum OnboardingStep: Int, CaseIterable {
    ...
    static var indicatorSteps: Int { 6 }

    var showsProgressDots: Bool { self != .trial1 && self != .trial2 }
    var hasBuiltInCTA: Bool {
        self == .state || self == .examDate || self == .trial1 || self == .trial2
    }
}
...
struct OnboardingFlowView: View {
    ...
    private var currentStepView: some View {
        ...
        case .state:
            OnboardingStateStepView(onAdvance: { advance() })
        case .examDate:
    ...
    private var currentIndicatorIndex: Int {
        ...
        case .state: return 3
        case .examDate: return 4
        case .rateUs: return 5
