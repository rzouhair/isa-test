...
struct OnboardingHeroView: View {
    ...
    var body: some View {
        VStack(spacing: 28) {
            ...
            Text("1,020+ real exam questions. Timed simulator. Every endorsement.")
                .font(.system(size: 16))
            ...
            HStack(spacing: 10) {
                badge(icon: "truck.box.fill", label: "Class A & B")
                badge(icon: "exclamationmark.triangle.fill", label: "HazMat")
                badge(icon: "checkmark.seal.fill", label: "All endorsements")
            }
