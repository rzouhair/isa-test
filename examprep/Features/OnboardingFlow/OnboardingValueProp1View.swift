...
/// "750+ real ISA exam questions" — animated counter, then a stack of
/// ISA domain cards with confetti in the background.
struct OnboardingValueProp1View: View {
    ...
    private let finalCount: Double = 750
    private let cards: [CategoryItem] = [
        .init(label: "Tree Biology", icon: "leaf.fill"),
        .init(label: "Soil Management", icon: "square.grid.3x3.fill"),
        .init(label: "Pruning", icon: "scissors"),
        .init(label: "Diagnosis & Treatment", icon: "stethoscope"),
        .init(label: "Tree Risk", icon: "exclamationmark.triangle.fill"),
    ]
        ...
        ZStack {
            ...
            VStack(spacing: 22) {
                ...
                VStack(spacing: 6) {
                    ...
                    Text("ISA Arborist study questions")
                        .font(.system(size: 20, weight: .semibold, design: .rounded))
                        .foregroundStyle(.white)

                    Text("All 10 domains. Aligned to ISA Best Management Practices and ANSI standards.")
                        .font(.system(size: 14))
