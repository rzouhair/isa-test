...
struct AppPreviewCardsView: View {
    ...
    private var frontCard: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            // Answer rows
            VStack(spacing: 5) {
                answerRow(letter: "A", text: "High beams", state: .neutral)
                answerRow(letter: "B", text: "Low beams", state: .correct)
                answerRow(letter: "C", text: "Parking lights", state: .neutral)
                answerRow(letter: "D", text: "No lights", state: .neutral)
            }
            .padding(.top, 2)
