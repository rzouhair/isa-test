...
class SettingsViewModel {
    ...
    func handleItemTap(_ item: SettingsItem) {
        ...
        case .examDate, .bookmarks, .flashcards, .savedFlashcards, .aiTutor:
    ...
    enum SettingsSection: String, CaseIterable, Identifiable {
        ...
        var items: [SettingsItem] {
            switch self {
            case .study:
                var items: [SettingsItem] = [.examDate, .flashcards, .bookmarks, .savedFlashcards]
            ...
            case .legal:
                ...
                return legal
            #if DEBUG
            // .toggleDebugPro is rendered as a Toggle directly in SettingsView (Developer section)
    ...
    enum SettingsItem: String, CaseIterable, Identifiable {
        ...
        var name: String {
            ...
            case .bookmarks: return "Bookmarked Questions"
            case .savedFlashcards: return "Saved Flashcards"
        ...
        var icon: String {
            ...
            case .savedFlashcards: return "bookmark.fill"
        ...
        var route: Router.Route? {
            ...
            case .flashcards: return .flashcardsLibrary
            case .bookmarks: return .bookmarks
            case .savedFlashcards: return .flashcardBookmarks
