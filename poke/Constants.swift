...
class Constants {
    ...
    ///
    ///
    static let appName = "Poke" /// TODO: Update to your app name
    ...
    /// API Keys
    static let revenueCat = "appl_luDaatAQFBJuDfZQQgPBFfcgQLf" /// IMPORTANT: This API key is set to poke RevenueCat project. Change it to yours...
