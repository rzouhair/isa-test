...
""".replaceVariables(with: ["banknote": banknote])
    ...
    static func valuation (banknote: String) -> String {
        return """
Search the web for the current market value of the {{banknote}} banknote in both circulated and uncirculated conditions from reputable sources such as collector websites, auction listings, and numismatic marketplaces.'
""".replaceVariables(with: ["banknote": banknote])
    }
