...
final class WatchlistPriceService: Sendable {
    ...
    func sendCompletionNotification(success: Int, failed: Int) {
        ...
        let request = UNNotificationRequest(
            identifier: "paperscan_watchlist_refresh",
            content: content,
            trigger: trigger
        )
    ...
    private static let reminderIdentifier = "paperscan_watchlist_reminder"
    ...
    static func scheduleRecurringReminder() {
        ...
        content.body = "Open PaperScan to see the latest prices on your watched cards."
        content.sound = .default
