...
#Preview {
    Accordion(items: [
        ...
        AccordionItem(
            title: "Is paperscan for beginners?",
            description: "Of course it is! paperscan Xcode project is built on top of the clean architecture and best coding practices. I would encourage everyone to dive into that! It will help tremendously not only your project but also your career as iOS Developer as many companies require some knowledge of the clean architecture and SOLID principles."
        ),
        AccordionItem(
            title: "Is paperscan being continuosly updated?",
            description: "Yes, I am constantly working on improving this code based on my current needs for my apps. paperscan gets updates based on customers feedback, new iOS versions, bug fixes, and so on..."
        )
    ])
}
