...
final class AIService {
    ...
    func sendMessage(_ text: String, initialMessages: [Message]? = nil, functions: [FunctionDefinition]? = nil, model: String = "gpt-4.1-mini") async throws -> [Message]? {
    ...
    func sendToolCompletion<T: Decodable>(prompt: String, tools: [FunctionDefinition], model: String = "gpt-4.1-mini") async -> T? {
